...
const DownloadPage = () => {
  const megaURL = "https://mega.nz/file/p6hnTYIS#_Anj_35_MXd5Rwx2-9w1pJ_sTe_lXrbFlCWBoz3ds70";
        ...
        >
          ...
          <div className="px-8 py-10 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link to="/app/activate" className="group p-6 bg-yellow-50 border-2 border-yellow-200 rounded-2xl hover:border-yellow-500 transition-all">
