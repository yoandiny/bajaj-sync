...
import { Plus, Edit2, Phone, CreditCard, User, Building, CheckCircle2, Loader2, Car, Star, RefreshCw } from 'lucide-react';
          ...
          return (
            <div key={driver.id} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              <div className="flex justify-between items-start mb-4">
                <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center text-xl font-bold text-gray-600 group-hover:bg-yellow-500 group-hover:text-white transition-colors shadow-inner">
